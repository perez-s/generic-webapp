...
CREATE TABLE IF NOT EXISTS public.aforos (
  ...
  CONSTRAINT aforos_placa_id_fkey FOREIGN KEY (placa_id) REFERENCES public.vehicles(id) ON UPDATE CASCADE
);
...
CREATE INDEX IF NOT EXISTS idx_aforos_fecha ON public.aforos(fecha DESC);
